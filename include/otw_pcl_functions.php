...
if( !function_exists( 'otw_pcl_init' ) ){
	...
	function otw_pcl_init(){
		...
		$otw_pcl_factory_object->add_plugin( $otw_pcl_plugin_id, dirname( dirname( __FILE__ ) ).'/otw_popping_content.php', array( 'menu_parent' => 'otw-pcl', 'lc_name' => __( 'License Manager', 'otw_pcl' ), 'menu_key' => 'otw-pcl' ) );
...
if( !function_exists( 'otw_pcl_init_admin_menu' ) ){
	...
	function otw_pcl_init_admin_menu(){
		...
		add_submenu_page( 'otw-pcl', __( 'Plugin Options', 'otw_pcl'), __('Plugin Options', 'otw_pcl'), 'manage_options', 'otw-pcl-options', 'otw_pcl_plugin_options' );
